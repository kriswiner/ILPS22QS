...
uint8_t PODR = P_10Hz, AVG = avg_16, MODE = mode1, LPF = lpf_odr9;     
uint8_t ILPS22Qstatus;
float Temperature, Pressure, altitude, QVAR;
...
//    Pressure = (float) ILPS22Q.readAltimeterPressure()/4096.0f;
    int32_t rawQVAR =  ILPS22Q.readAltimeterPressure();
    QVAR = (float) rawQVAR/438000.0f;
...
//    altitude = 145366.45f*(1.0f - pow((Pressure/1013.25f), 0.190284f)); 
     ...
     if(SerialDebug) {
      ...
      Serial.print("QVAR = "); Serial.print(QVAR, 2);  Serial.println(" mV");// QVAR in mV
     }

     //For data plotting
//     Serial.print(millis()/1000);Serial.print(",");
//     Serial.print(QVAR, 2); Serial.print(","); Serial.println(Temperature, 2);  
    }
